<template>
	<div>
		...
		<ul class="list-item">
	    	<li class="item">
	    		<a href="#"><img src="images/news/news_01.jpg"></a>
	    	</li>
	    	<li class="item">
	    		<a href="#"><img src="images/news/news_02.jpg"></a>
	    	</li>
	    	<li class="item">
	    		<a href="#"><img src="images/news/news_03.jpg"></a>
	    	</li>
	    	<li class="item">
	    		<a href="#"><img src="images/news/news_04.jpg"></a>
	    	</li>
	    	<li class="item">
	    		<a href="#"><img src="images/news/news_05.jpg"></a>
	    	</li>
	    	<li class="item">
	    		<a href="#"><img src="images/news/news_06.jpg"></a>
	    	</li>
	    </ul>
	</div>
	<!-- 二维码 -->
		...
		<div class="footer_top">
			<div class="footer_top_center">
				<div class="box_img margin-right">
					<img src="images/icon/index_102.jpg" class="pre">
					<span>关注官方微信</span>
				</div>
				<div class="box_img">
					<img src="images/icon/index_104.jpg" class="pre">
					<span>关注官方微博</span>
				</div>
